...
### Windows
**Просто дважды кликните на `quick-start.bat`** - никаких командных строк! 🎯

💡 **Хотите ярлык на рабочем столе?** Запустите `create-desktop-shortcut.bat` - и всё готово!

### Android (Termux)
**Установите Termux:Widget и добавьте виджет на экран** - запуск одним касанием! 📱

📖 **[Подробная инструкция по запуску в один клик →](ONE_CLICK_SETUP.md)**

## Возможности

- ✅ **Запуск в один клик** - без командной строки!
...
- ✅ Поддержка разных типов элементов:
  ...
  - Файлы (открытие конкретного файла)
...
```
Поддерживаются абсолютные пути, пути с `~` и Windows-пути вроде `C:\\Users\\Username\\Documents\\note.txt`.
